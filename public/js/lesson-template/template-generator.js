...
function generateLessonHTML(chapterId, config, metadata) {
  ...
  // Handle conditional ekstraøvelser tab
  if (metadata.hasEkstraovelser) {
    const ekstraTab = `
<div class="tab-content hidden space-y-8" id="ekstraovelser">
  <!-- Ekstraøvelser lastes dynamisk av exercises-content-loader.js -->
  <div id="ekstraovelser-content" class="space-y-8"></div>
...
Lesson: ${chapterId} (${metadata.germanTitle})
